...
<head>
    ...
    <script type="text/javascript">
        ...
        function showShareUI(operationMode) {
		    ...
		    act.setTitle("Healthybites");
		    act.setSubtitle("Step towards fitness");
		    act.setDescription("Healthbites, a health based recommendation system."
		        + " Share on the top social networks using Facebook Connect, Twitter for Websites, " 
		        + "LinkedIn, Foursquare and more.");

            // Setting a link back to the publishing source
		    act.setLinkBack("http://localhost:8080/healthybites/");
